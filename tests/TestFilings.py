...
class TestFilings(TestCase):
	...
	def test_run_compile_income_statement(self):
		...
		self.fail("currently have the row_labels, need to check with different cik's," 
			+ "and after that store where the indexes for add_accounts parameter is in row_labels")